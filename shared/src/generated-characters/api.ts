...
export async function requestGeneratedCharacterImage(
  ...
  const response = await performRequest(
    buildRequestUrl(GENERATED_CHARACTER_API_PATH, options.baseUrl),
    {
      method: 'POST',
      headers: {
...
export async function listGeneratedCharacterModels(
  fetchImpl: typeof fetch = fetch,
  baseUrl?: string,
) {
  const response = await performRequest(
    buildRequestUrl(GENERATED_CHARACTER_MODELS_API_PATH, baseUrl),
    {
      method: 'GET',
    },
    fetchImpl,
...
export async function saveGeneratedCharacterAssets(
  ...
  const response = await performRequest(
    buildRequestUrl(GENERATED_CHARACTER_ASSET_API_PATH, baseUrl),
    {
      method: 'POST',
      headers: {
        'Content-Type': 'application/json',
...
export async function deleteGeneratedCharacterAssets(
  ...
  const response = await performRequest(
    buildRequestUrl(`${GENERATED_CHARACTER_ASSET_API_PATH}/${encodeURIComponent(storageId)}`, baseUrl),
    {
      method: 'DELETE',
    },
    fetchImpl,
