...
describe('GeneratedStandeePlayer', () => {
  ...
  it('renders the back card surface as a rotated reverse side', () => {
    ...
    const firstSurfaceProps = mockGeneratedStandeeCardSurfaceMesh.mock.calls[0]?.[0] as
      | { mirrorX?: boolean; rotation?: [number, number, number]; excludeFromSelectionOutline?: boolean }
      | undefined
    ...
    expect(secondSurfaceProps?.mirrorX).toBeUndefined()
  })
