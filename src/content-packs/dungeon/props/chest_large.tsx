...
const MODEL_NAME = 'chest_large'
const LID_NODE_NAME = 'chest_large_lid'
...
function DungeonChestLargeVariant({ objectProps, ...props }: ContentPackComponentProps) {
...
export const dungeonChestLargeAsset = createDungeonAsset({
  ...
  Component: DungeonChestLargeVariant,
  metadata: {
    connectors: [
      {
        point: [0, 0, 0],
