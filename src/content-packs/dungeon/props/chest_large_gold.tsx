...
const MODEL_NAME = 'chest_large_gold'
const LID_NODE_NAME = 'chest_large_gold_lid'
...
function DungeonChestLargeGoldVariant({ objectProps, ...props }: ContentPackComponentProps) {
...
export const dungeonChestLargeGoldAsset = createDungeonAsset({
  ...
  Component: DungeonChestLargeGoldVariant,
  metadata: {
    connectors: [
      {
        point: [0, 0, 0],
