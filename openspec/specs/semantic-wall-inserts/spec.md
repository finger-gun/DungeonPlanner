# semantic-wall-inserts

## Purpose

Define style-driven architectural insert behavior for profile-driven walls, including anchor derivation, repeated inserts, and side-specific ownership.
