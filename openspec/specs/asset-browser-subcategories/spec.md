# asset-browser-subcategories

## Purpose

Define top-level category and subcategory browsing for the unified asset browser while preserving placement context and safe metadata defaults.
