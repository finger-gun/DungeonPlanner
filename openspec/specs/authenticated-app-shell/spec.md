...
Define behavior for the dedicated authenticated DungeonPlanner app surface, including its relationship to public surfaces, signed-out marketing and login routing, branded shell treatment, and signed-in workspace navigation.
